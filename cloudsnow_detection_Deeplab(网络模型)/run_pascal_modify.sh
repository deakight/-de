...
ROOT_DIR=/home/lab532/gjh20190805/previous_works  # data path
CAFFE_DIR=/home/lab532/gjh20190805/previous_works/caffe_v3  # caffe path 
...
if [ "${EXP}" = "." ]; then
    NUM_LABELS=3
   # DATA_ROOT=${ROOT_DIR}/zy3_data_475
   # DATA_ROOT=${ROOT_DIR}/zy3_115_train
     #DATA_ROOT=${ROOT_DIR}/images_labels_475/subimage_train_data_475
     DATA_ROOT=${ROOT_DIR}/images_cloud_snow	 
    # NUM_LABELS=21
...
if [ ${RUN_TRAIN} -eq 1 ]; then
    #
    LIST_DIR=${EXP}/list
    TRAIN_SET=train${TRAIN_SET_SUFFIX} # train_aug.txt
    ...
    #
     #MODEL=/home/jh1020/caffe_v3/voc2012_siam/model/deeplab_largeFOV/train_iter_40000.caffemodel
      MODEL=${EXP}/model/${NET_ID}/train_iter_72305.caffemodel
    #
    echo Training net ${EXP}/${NET_ID}
    for pname in train solver; do
				sed "$(eval echo $(cat sub.sed))" \
						${CONFIG_DIR}/${pname}.prototxt > ${CONFIG_DIR}/${pname}_${TRAIN_SET}.prototxt
                                                 # train.prototxt   train_train_aug.prototxt
    done
        CMD="${CAFFE_BIN} train \
         --solver=${CONFIG_DIR}/solver_${TRAIN_SET}.prototxt \
         --gpu=${DEV_ID}"
# /home/gjh/cell_images/deeplab-v2-master/build_release/tools/caffe.bin/ train \
#   --solver=/home/gjh/cell_images/deeplab-v2-master/voc2012/config/deeplab_largeFOV/solver_train_aug.prototxt \
#   --gpu=0
		if [ -f ${MODEL} ]; then
